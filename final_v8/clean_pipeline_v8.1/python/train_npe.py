...
def main() -> None:
    ...
    # Adaptive validation split: 10% of data, capped at 500, minimum 10
    val_frac = 0.1
    n_val = int(val_frac * n)
    n_val = max(10, min(500, n_val))  # At least 10, at most 500
    n_val = min(n_val, n - 10)  # Ensure at least 10 training samples remain
