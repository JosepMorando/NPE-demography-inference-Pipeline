...
# --- Helper Functions (Must match compute_sim_summaries.R) ---
...
# NOTE: If your simulation pipeline includes LD statistics (x_ld),
# you will have a dimension mismatch here unless you also append LD stats
# (or zeros if they cannot be computed for pooled data).
